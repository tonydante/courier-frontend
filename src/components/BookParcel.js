...
import { createParcel, logout } from '../actions'


class BookParcel extends Component {
  constructor(props) {
    super(props);
    this.state = {
      clientName: '',
...
/**
      ...
      <div className="row">
        <nav className="col-md-2 d-none d-md-block bg-light sidebar">
          <div className="sidebar-sticky">
            <ul className="nav flex-column">
              ...
              <li className="nav-item">
                <Link className="nav-link active" to="/parcel">
        ...
        <main role="main" className="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 className="h2">Book a parcel</h1>
          </div>    
          <form>
  ...
  <button type="submit" className="btn btn-primary" onClick={this.onSubmit}>Book It</button>
</form>      
        </main>
      </div>
    </div>
...
export default connect(null, {createParcel, logout})(withRouter(BookParcel))