        ...
        <div className="container">
          <div className="grid">
            ...
            <div className="grid-item medium-width-6 large-width-8 footer__main-about">
              <p>Cricket Deliveries allows businesses and individuals to compare quotes for cheap courier services for deliveries within the UK, European and Worldwide destinations.</p>
      ...
      <div className="footer__secondary">
        <div className="container">
          <ul className="footer__legal">
            <li>Copyright &copy; Cricket Deliveries Ltd 2018</li>
          ...
          <ul className="footer__social">
            <li><a className="icon--facebook" href="https://www.facebook.com/ParcelMonkey/" target="_blank" title="Follow us on Facebook">Cricket Deliveries Facebook</a></li>
            <li><a className="icon--twitter" href="https://twitter.com/parcelmonkey" target="_blank" title="Follow us on Twitter">Cricket Deliveries Twitter</a></li>
            <li><a className="icon--youtube" href="https://www.youtube.com/c/parcelmonkey" target="_blank" title="Follow us on YouTube">Cricket Deliveries YouTube</a></li>
            <li><a className="icon--linkedin" href="https://www.linkedin.com/company/parcelmonkey-com/" target="_blank" title="Follow us on LinkedIn">Cricket Deliveries LinkedIn</a></li>
            <li><a className="icon--gplus" href="https://plus.google.com/+parcelmonkey" target="_blank" title="Follow us on Google+">Cricket Deliveries Google+</a></li>
          </ul>
